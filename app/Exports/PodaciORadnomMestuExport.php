...
class PodaciORadnomMestuExport implements FromQuery, WithHeadings, WithMapping
{
    ...
    public function map($row): array
    {
        return [
            ...
            $row->datum_slanja_zahteva_za_sprovodjenje_ofk_provera ? Carbon::parse($row->datum_slanja_zahteva_za_sprovodjenje_ofk_provera)->format('d.m.Y') : '',
            ...
            $row->datum_slanja_zahteva_za_sprovodjenje_pfk_provera ? Carbon::parse($row->datum_slanja_zahteva_za_sprovodjenje_pfk_provera)->format('d.m.Y') : '',
            ...
            $row->datum_slanja_zahteva_za_sprovodjenje_pk_provera ? Carbon::parse($row->datum_slanja_zahteva_za_sprovodjenje_pk_provera)->format('d.m.Y') : '',
